...
if (!catalogPath || !output || !priorPaths.length) throw new Error('Usage: node scripts/exclude-attempted-store-corpus.js --catalog <verified-catalog.json> --prior <results.json> [--prior <results.json> ...] --output <follow-up-catalog.json>');
...
const followUp = {
  ...
  source: { ...catalog.source, priorRunExclusions: { attemptedPackages: attemptedPackages.size, priorRuns } },
  apps,
};
