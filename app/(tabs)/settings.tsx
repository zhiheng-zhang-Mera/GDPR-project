...
export default function SettingsScreen() {
  const { availablePacks, selectedRegulationId, selectRegulation, clearFindings, findings } = usePrivacy();
    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.infoCard}>
          ...
          {availablePacks.find((pack) => pack.id === selectedRegulationId)?.sourceUrl && (
            <TouchableOpacity accessibilityRole="link" onPress={() => void Linking.openURL(availablePacks.find((pack) => pack.id === selectedRegulationId)!.sourceUrl!)} style={styles.sourceLink}>
        ...
        <Text style={styles.version}>Privacy Lens 1.1.0 · Research prototype release candidate</Text>
      </ScrollView>
