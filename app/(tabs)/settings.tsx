...
import { packGovernanceLabel, sourceLifecycleLabel } from '../../src/regulations/governance';
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {selectedPack.sources.length > 0 ? (
          <View style={styles.sourceList}>
            {selectedPack.sources.map((source) => {
              ...
              return (
                <TouchableOpacity key={source.url} accessibilityRole="link" accessibilityLabel={`Open ${SOURCE_STATUS_LABEL[source.status]} source: ${source.title}. ${sourceLifecycleLabel(source.lifecycle)}. ${source.versionLabel}`} accessibilityHint="Opens the official source in your browser" onPress={() => void Linking.openURL(source.url)} style={styles.sourceCard}>
        ...
        <Text style={styles.version}>Privacy Lens 1.7.0 · Legal-source lifecycle research candidate</Text>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  sourceHeading: { marginTop: 29, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 }, sourceHeadingCopy: { flex: 1 }, sourceCount: { minWidth: 34, height: 34, paddingHorizontal: 8, alignItems: 'center', justifyContent: 'center', borderRadius: 12, backgroundColor: T.colors.mint }, sourceCountText: { color: T.colors.primaryDark, fontSize: 13, fontWeight: '900' }, sourceList: { gap: 9, marginTop: 13 }, sourceCard: { minHeight: 146, padding: 15, borderRadius: 17, borderWidth: 1, borderColor: T.colors.line, backgroundColor: '#FFFFFF', ...T.shadow.card }, sourceTop: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, sourceBadge: { paddingHorizontal: 8, paddingVertical: 5, borderRadius: T.radius.pill }, bindingBadge: { backgroundColor: T.colors.mint }, guidanceBadge: { backgroundColor: T.colors.infoSoft }, consultationBadge: { backgroundColor: T.colors.warningSoft }, sourceBadgeText: { color: T.colors.ink, fontSize: 9, lineHeight: 12, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 0.35 }, sourceTitle: { color: T.colors.ink, fontSize: 14, lineHeight: 19, fontWeight: '900', marginTop: 10 }, sourceVersion: { color: T.colors.inkSoft, fontSize: 11, lineHeight: 16, fontWeight: '700', marginTop: 4 }, sourceLifecycle: { alignSelf: 'flex-start', color: '#705826', fontSize: 10, lineHeight: 15, fontWeight: '900', marginTop: 7 }, sourceMeta: { color: T.colors.muted, fontSize: 11, lineHeight: 16, marginTop: 3 }, noSources: { minHeight: 74, marginTop: 13, padding: 15, flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: 17, backgroundColor: T.colors.warningSoft, borderWidth: 1, borderColor: '#EAD9B2' }, noSourcesText: { flex: 1, color: '#705826', fontSize: 12, lineHeight: 18, fontWeight: '700' },
