...
import { packGovernanceLabel, sourceLifecycleLabel, sourceReviewLabel, sourceReviewState } from '../../src/regulations/governance';
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.version}>Privacy Lens 1.8.0 · Source-review expiry research candidate</Text>
      </ScrollView>
