...
const LEGAL_REVIEW_LABEL = { CURRENT: 'Legal review current', EXPIRED: 'Legal review expired', NOT_PROVIDED: 'Legal review not recorded', NOT_APPLICABLE: 'Non-legal pack', NOT_RECORDED: 'Legal review not recorded' } as const;
