...
const LEGAL_REVIEW_LABEL = { CURRENT: 'Signed legal review current', EXPIRED: 'Signed legal review expired', NOT_PROVIDED: 'Legal review not recorded', SOURCE_BUNDLE_MISMATCH: 'Source bundle changed', SIGNER_NOT_TRUSTED: 'Signer not trusted', SIGNER_REVOKED: 'Signer revoked', SIGNATURE_INVALID: 'Signature invalid', NOT_APPLICABLE: 'Non-legal pack', NOT_RECORDED: 'Legal review not recorded' } as const;
