...
try {
  ...
  fs.writeFileSync(deviceInput, JSON.stringify({ schema: 'privacy-lens.android-store-corpus-run.v1', corpusId: 'device-fixture', corpusKind: 'ACADEMIC_BENCHMARK', execution: 'AUTHORISED_DEVICE_RUN', results: [{ id: 'device-1', packageName: 'org.fixture.device1', cleanup: 'VERIFIED_REMOVED', wallClockElapsedMs: 5, installer: { oemPrompts: { continueInstall: 1, installerCompleted: 1 } }, afterLaunch: { memoryPssKb: 0 } }], failures: [{ id: 'device-2', packageName: 'org.fixture.device2', cleanup: 'NOT_STARTED', error: 'Failure [-99]' }] }));
  ...
  if (deviceSummary.completedAndVerifiedRemoved !== 1 || deviceSummary.runtimePermissionPrompts.unavailable !== 2 || deviceSummary.failuresByCategory.PACKAGE_MANAGER_REJECTED !== 1 || deviceSummary.executionOverhead.wallClockElapsedMs.mean !== 5 || deviceSummary.telemetry.afterLaunchMemoryPssKb.mean !== 0 || Object.prototype.hasOwnProperty.call(deviceSummary.telemetry, 'afterLaunchEstimatedPowerMah')) throw new Error('Device batch summarisation contract failed.');
  ...
  if (aggregate.completedAndVerifiedRemoved !== 1 || aggregate.failed !== 1 || aggregate.uniquePackagesProcessed !== 2 || aggregate.runtimePermissionPrompts.unavailable !== 2 || aggregate.telemetry.afterLaunchMemoryPssKb.mean !== 0 || Object.prototype.hasOwnProperty.call(aggregate.telemetry, 'afterLaunchEstimatedPowerMah')) throw new Error('Device batch aggregation contract failed.');
