...
try {
  ...
  if (deviceSummary.completedAndVerifiedRemoved !== 1 || deviceSummary.runtimePermissionPrompts.unavailable !== 2 || deviceSummary.failuresByCategory.PACKAGE_MANAGER_REJECTED !== 1 || deviceSummary.executionOverhead.wallClockElapsedMs.mean !== 5 || deviceSummary.executionOverhead.batteryStatsResetRequested !== 1 || deviceSummary.telemetry.afterLaunchMemoryPssKb.mean !== 0 || deviceSummary.telemetry.afterLaunchEstimatedPowerMah.observed !== 0) throw new Error('Device batch summarisation contract failed.');
