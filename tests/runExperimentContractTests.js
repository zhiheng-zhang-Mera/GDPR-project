...
try {
  ...
  if (deviceSummary.completedAndVerifiedRemoved !== 1 || deviceSummary.runtimePermissionPrompts.observedNotGranted !== 1 || deviceSummary.runtimePermissionPrompts.unavailable !== 1 || deviceSummary.runtimePermissionPrompts.dismissed !== 1 || deviceSummary.failuresByCategory.PACKAGE_MANAGER_REJECTED !== 1 || deviceSummary.executionOverhead.wallClockElapsedMs.mean !== 5 || deviceSummary.telemetry.afterLaunchMemoryPssKb.mean !== 0 || Object.prototype.hasOwnProperty.call(deviceSummary.telemetry, 'afterLaunchEstimatedPowerMah')) throw new Error('Device batch summarisation contract failed.');
  ...
  if (aggregate.completedAndVerifiedRemoved !== 1 || aggregate.failed !== 1 || aggregate.uniquePackagesProcessed !== 2 || aggregate.runtimePermissionPrompts.observedNotGranted !== 1 || aggregate.runtimePermissionPrompts.unavailable !== 1 || aggregate.runtimePermissionPrompts.dismissed !== 1 || aggregate.telemetry.afterLaunchMemoryPssKb.mean !== 0 || Object.prototype.hasOwnProperty.call(aggregate.telemetry, 'afterLaunchEstimatedPowerMah')) throw new Error('Device batch aggregation contract failed.');
