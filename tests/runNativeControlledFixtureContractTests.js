...
assert(bridge.includes('BuildConfig.DEBUG is true') && bridge.includes('runControlledTemporalFixture'), 'The JavaScript bridge must delegate the release/debug decision to the native BuildConfig.DEBUG boundary.');
