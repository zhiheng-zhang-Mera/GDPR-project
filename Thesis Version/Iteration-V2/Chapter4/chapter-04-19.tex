...
Each legal pack also carries a source register. A source records its title, exact document version, HTTPS location, issuing authority, authority status, lifecycle, and check date. The authority vocabulary distinguishes binding law, final guidance, and consultation material. The lifecycle vocabulary distinguishes material in force, final material, an open consultation, and a consultation that has closed while finalisation remains pending. The registry requires at least one binding-law record and requires the primary URL to appear in the register; missing versions, duplicate or malformed records, impossible dates, status--lifecycle mismatches, and closure dates inconsistent with the check date fail admission. The official Regulation is recorded as in force; final EDPB and endorsed WP29 guidance is recorded as final; Guidelines 1/2024 Version 1.0 and the 2026 DPIA template are recorded as consultation-closed pending finalisation rather than silently upgraded to final guidance \cite{eurlex2016,edpblia2024draft,edpbdpia2026consultation}. These controls make source state inspectable but do not authenticate an authority, prove a classification, or substitute for qualified legal review.
