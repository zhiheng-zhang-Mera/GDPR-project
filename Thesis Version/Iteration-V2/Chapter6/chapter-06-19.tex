...
Revision 19 operationalises more of this distinction by recording both authority status and lifecycle. This prevents the 2026 EDPB DPIA template and Guidelines 1/2024 Version 1.0 from silently acquiring the same status as the Regulation or final guidance after their consultation periods close \cite{edpblia2024draft,edpbdpia2026consultation}. The lifecycle is still maintainer-authored metadata and can become stale when an authority publishes a successor. Without automated official-source monitoring, signed retrieval, content hashing, and qualified review, the validator can enforce internal consistency but cannot establish authenticity, completeness, continuing currency, or legal correctness.
