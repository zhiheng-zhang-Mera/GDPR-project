% ==================== Chapter 6: Discussion, Limitations and Future Development (Integrated) ====================
\newpage
...
\begin{enumerate}
    \item implement and property-test fail-closed runtime validation (already prototyped);
    ...
    \item add multi-scale temporal and cumulative features with documented oracles (partially prototyped);
