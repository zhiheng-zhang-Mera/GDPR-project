...
Health-related applications make that mismatch especially consequential. Digital health systems may process symptoms, medication routines, reproductive information, movement patterns, sleep, location, or communications. The IQVIA review of digital-health development describes a field moving toward more specialised and evidence-oriented interventions \cite{9}. Parker and colleagues, studying Android health applications, found extensive data-sharing and transparency problems \cite{11}. These studies do not imply that every permission access is harmful, nor that every health application is governed identically. They establish that mobile-health privacy cannot be reduced to a one-time installation choice and that users, developers, researchers, and reviewers need better evidence about what a system can observe.
...
\subsection{The Evidence-to-Decision Gap}
