...
\hypersetup{
  pdftitle={Privacy Lens: An Evidence-Bounded Android Privacy Review Framework, Revision 12},
  pdfauthor={Zhiheng Zhang}
}
\title{Privacy Lens: An Evidence-Bounded Android Privacy Review Framework with Replaceable Regulation Packs (Revision 12)}
...
\tableofcontents
\newpage
\input{Iteration-V2/Chapter1/chapter-01-12}
...
\input{Iteration-V2/Chapter6/chapter-06-12}
\input{Iteration-V2/Chapter7/chapter-07-12}
